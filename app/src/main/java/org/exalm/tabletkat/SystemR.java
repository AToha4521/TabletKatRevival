...
public class SystemR {
    ...
    private static int get(XResources res, XModuleResources res2, String name, String type) {
        ...
        if (id <= 0) {
            try {
                ...
                Log.w("TabletKat/SystemR", "Failed to add fallback resource: " + name, t);
            }
            if (id <= 0) {
                Log.w("TabletKat/SystemR", "Cannot find " + SYSTEMUI_PACKAGE + "/" + type + ":" + name);
            }
        }
        return id;
    }
    ...
    public static void init(XResources res, XModuleResources res2){
        ...
        drawable.ic_sysbar_airplane = get(res, res2, "stat_sys_airplane_mode", "drawable");
        drawable.ic_sysbar_wifi = get(res, res2, "stat_sys_wifi_signal_4_fully", "drawable");
        drawable.ic_sysbar_bluetooth = get(res, res2, "stat_sys_data_bluetooth", "drawable");
