...
public class TkR {
    ...
    public static class drawable {
        ...
        public static int ic_sysbar_volume_up;
        public static int ic_sysbar_volume_down;
        public static int ic_sysbar_screenshot;
        public static int ic_sysbar_menu;
        public static int ic_sysbar_power;
    }
    ...
    public static void init(XResources res, XModuleResources res2) {
        ...
        drawable.ic_sysbar_volume_up = add(res, res2, R.drawable.ic_sysbar_volume_up);
        drawable.ic_sysbar_volume_down = add(res, res2, R.drawable.ic_sysbar_volume_down);
        drawable.ic_sysbar_screenshot = add(res, res2, R.drawable.ic_sysbar_screenshot);
        drawable.ic_sysbar_menu = add(res, res2, R.drawable.ic_sysbar_menu);
        drawable.ic_sysbar_power = add(res, res2, R.drawable.ic_sysbar_power);
        ...
        id.nav_buttons = add(res, res2, R.id.nav_buttons);
