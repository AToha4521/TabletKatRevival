    ...
    public void addHooks(ClassLoader cl) {
        ...
        XposedHelpers.findAndHookMethod(recentsPanelViewClass, "onFinishInflate", new XC_MethodHook() {
            ...
            protected void afterHookedMethod(XC_MethodHook.MethodHookParam param) throws Throwable {
                ...
                View firstChild = f.getChildAt(0);
                if (firstChild instanceof ViewGroup) {
                    ((ViewGroup) firstChild).addView(v2, 0, params2);
                }
                ...
                TextView noRecentApps = (TextView) f.findViewById(TkR.id.no_recent_apps);
                if (noRecentApps != null) {
                    noRecentApps.setText(SystemR.string.status_bar_no_recent_apps);
                }
                if (overlay) {
                    View vNoRecent = f.findViewById(TkR.id.no_recent_apps);
                    if (vNoRecent != null) {
                        vNoRecent.setPadding(0, 0, 0, 0);
                    }
                }
            }
        });
