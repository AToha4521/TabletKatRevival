...
//        final Class homeSettingsClass = XposedHelpers.findClass("com.android.settings.HomeSettings", cl);
        ...
        XposedHelpers.findAndHookMethod(Activity.class, "onCreate", Bundle.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                ...
                int themeResId = (Integer) XposedHelpers.callMethod(a, "getThemeResId");
                String name = a.getResources().getResourceName(themeResId);
...
*/
        ...
        XposedHelpers.findAndHookMethod(manageApplicationsClass, "onCreateView",
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                int i = (int) rootView.getContext().getResources().getDimension(rootView.getContext().getResources().getIdentifier("preference_fragment_padding_side", "dimen", "android"));
        ...
        XposedHelpers.findAndHookMethod(manageApplicationsTabInfoClass, "build",
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                int i = (int) v.getContext().getResources().getDimension(v.getContext().getResources().getIdentifier("preference_fragment_padding_side", "dimen", "android"));
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                if (shouldInset) {
                    mInsetSide = mListView.getResources().getDimensionPixelOffset(
                        mListView.getContext().getResources().getIdentifier("preference_fragment_padding_side", "dimen", "android"));
                }
    ...
    public void initResources(XResources res, XModuleResources res2) {
        ...
        res.setReplacement(TabletKatModule.SETTINGS_PACKAGE, "dimen", "settings_side_margin",
                res2.fwd(res2.getIdentifier("preference_fragment_padding_side", "dimen", "android")));
        ...
        res.hookLayout("android", "layout", "breadcrumbs_in_fragment", new XC_LayoutInflated() {
            ...
            public void handleLayoutInflated(XC_LayoutInflated.LayoutInflatedParam layoutInflatedParam) throws Throwable {
                ...
                int padding = v.getResources().getDimensionPixelSize(
                        v.getContext().getResources().getIdentifier("preference_fragment_padding_side", "dimen", "android"));
