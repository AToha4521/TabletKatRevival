...
public class TabletStatusBarView extends FrameLayout {
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        final boolean disableHome = ((disabledFlags & ViewConstants.STATUS_BAR_DISABLE_HOME) != 0);
        final boolean disableRecent = ((disabledFlags & ViewConstants.STATUS_BAR_DISABLE_RECENT) != 0);
        final boolean disableBack = ((disabledFlags & ViewConstants.STATUS_BAR_DISABLE_BACK) != 0)
                && ((mNavigationIconHints & StatusBarManager.NAVIGATION_HINT_BACK_ALT) == 0);
        final boolean disableSearch = ((disabledFlags & ViewConstants.STATUS_BAR_DISABLE_SEARCH) != 0);
